...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://github.com/macksyn/Lussh-AI/blob/main/lib/assets/suhail.jpg?raw=true" ; // SET LOGO FOR IMAGE 
global.caption = process.env.CAPTION || global.caption || "ᴸᵘˢˢʰ ᴬᴵ™" 


global.devs = "2348166353338" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "null";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "2348166353338";
...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "2348089782988,923xxxxxxxx";
...
module.exports = {
  ...
  caption : global.caption || "" , // ```『 ᴸᵘˢˢʰ ᴬᴵ™ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
